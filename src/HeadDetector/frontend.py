...
try:
    ...
    from HeadDetector.backend import TinyYoloFeature, FullYoloFeature, MobileNetFeature, SqueezeNetFeature, \
...
class YOLO(object):
    def __init__(self, backend,
        ...
        if backend == 'Inception3':
            ...
            raise Exception(
                'Architecture not supported! Only support Full Yolo, Tiny Yolo, MobileNet, SqueezeNet, VGG16, '
                'ResNet50, and Inception3 at the moment!')
