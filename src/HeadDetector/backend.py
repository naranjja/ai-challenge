...
FULL_YOLO_BACKEND_PATH  = f"{execution_path}/full_yolo_backend.h5"   # should be hosted on a server
TINY_YOLO_BACKEND_PATH  = f"{execution_path}/tiny_yolo_backend.h5"   # should be hosted on a server
SQUEEZENET_BACKEND_PATH = f"{execution_path}/squeezenet_backend.h5"  # should be hosted on a server
MOBILENET_BACKEND_PATH  = f"{execution_path}/mobilenet_backend.h5"   # should be hosted on a server
INCEPTION3_BACKEND_PATH = f"{execution_path}/inception_backend.h5"   # should be hosted on a server
VGG16_BACKEND_PATH      = f"{execution_path}/vgg16_backend.h5"       # should be hosted on a server
RESNET50_BACKEND_PATH   = f"{execution_path}/resnet50_backend.h5"    # should be hosted on a server
